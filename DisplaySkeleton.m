...
% 8 - mid left foot
% 9 - bottom left foot
% 10 - upper right torso
% 11 - upper left torso
% 12 - lower right torso
% 13 - lower left torso
% 14 - realhip
% 15 - spine
% 16 - spine1
% 17 - spine2
% 18 - neck
% cutterNames = {'Miggy02', 'Joel03', 'Marish03', 'Jay07', 'Vien03'};
for cutterNum = 1:5
    cutterNames = {'Miggy02', 'Joel03', 'Marish03', 'Jay07', 'Vien03'};
    load(['CaptainAmerica_20161024_by_', cutterNames{cutterNum}, '_GPSClustering']);
    figure
    hold on
    ...
    % fname = strcat(charName, '_GPSClusters_', num2str(imgcounter), '.jpg');
    % saveas(gcf, fname);    
    printPNG(gcf, [fName, '_1', '_Skeleton', '.png']);
%     ax = gca;
%     ax.XColor = [1 1 1];
%     ax.YColor = [1 1 1];
%     printPNG(gcf, [fName, '_GPSFinal.png']);
end
